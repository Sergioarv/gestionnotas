package com.natalia.gestionnotas.security;

import com.natalia.gestionnotas.security.jwt.JwtEntryPoint;
import com.natalia.gestionnotas.security.jwt.JwtTokenFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/v3/api-docs/**","/v2/api-docs/**", "/swagger-ui/**",
                        "/swagger-resources/**","/configuration/**", "/doc/swagger-ui/**").permitAll()
